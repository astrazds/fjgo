...
fjgo -R origin release view v1.4.2
fjgo -R origin release create v1.4.2 --body-file notes.md --dry-run --yes
fjgo -R origin release create v1.4.2 --notes-file notes.md --dry-run --yes
fjgo -R origin release create v1.4.2 --body-file notes.md --yes
