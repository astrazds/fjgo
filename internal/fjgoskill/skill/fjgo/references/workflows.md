...
fjgo -R origin release view v1.1.0
fjgo -R origin release create v1.1.0 --body-file notes.md --dry-run --yes
fjgo -R origin release create v1.1.0 --notes-file notes.md --dry-run --yes
fjgo -R origin release create v1.1.0 --body-file notes.md --yes
