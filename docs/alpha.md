...
```sh
fjgo -R origin issue create --title "fjgo v1.4.1 field test" --body "Created during fjgo v1.4.1 validation." --dry-run --yes
fjgo -R origin issue create --title "fjgo v1.4.1 field test" --body "Created during fjgo v1.4.1 validation." --yes
fjgo -R origin issue comment ISSUE_NUMBER --body "v1.4.1 validation comment." --dry-run --yes
fjgo -R origin issue comment ISSUE_NUMBER --body "v1.4.1 validation comment." --yes
...
fjgo -R origin pr comment PR_NUMBER --body "v1.4.1 validation PR note." --dry-run --yes
...
fjgo -R origin repo edit --description "fjgo v1.4.1 validation preview" --dry-run --yes
...
fjgo -R origin release create v0.0.0-field-test --body "v1.4.1 field-test release preview." --dry-run --yes
