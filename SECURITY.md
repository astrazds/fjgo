...
Report suspected vulnerabilities privately. Open a Forgejo issue only after
stripping tokens, passwords, one-time codes, and private response bodies, or
contact the repository owner through
[astrazds](https://repos.astrazds.net/astrazds) and ask for a private channel.
